...
def main():
    ...
    st.set_page_config(page_title="Chat with PDFs", page_icon=":pages:", layout="wide")
    # st.image("templates/realpagesmall.png")

    st.write(css, unsafe_allow_html=True)

    # st.header("Hi, I am RealMan")
    ...
    # pdf_file = "./templates/Employee-Handbook--Effective-May-23--2024.pdf"
    ...
    with st.sidebar:
        ...
        if st.button("Run"):
            with st.spinner("Processing... Please wait for 1 or 2 minutes to upload the document"):
